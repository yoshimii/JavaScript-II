...
let ticketPriceTotal = runners.reduce(function(acc, currentValue){
...
// Problem 1
//The Fun Run needs more money... erm... I mean new sponsors. Return all the emails and company names of all runners. 
let potentialSponsor = runners.map(function(funder){
    return [{email: funder.email}, {company_name: funder.company_name}];
})
